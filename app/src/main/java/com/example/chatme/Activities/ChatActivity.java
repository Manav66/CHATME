...
import com.example.chatme.Adapters.MessagesAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog3.setMessage("Please Wait");
        ...
        video.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ChatActivity.this, VideoCalling.class);
    ...
    protected void onResume() {
        super.onResume();
        String currenntID = FirebaseAuth.getInstance().getUid();
        database.getReference().child("presence").child(currenntID).setValue("Online");
    }
